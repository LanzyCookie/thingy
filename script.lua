-- Crumbs Admin - Console Executable Version WITH GUIS
...
-- Register Commands (ALL COMMANDS FROM BEFORE)
...
-- Load notification with the cute message
task.wait(0.5)
for _, player in ipairs(Players:GetPlayers()) do
